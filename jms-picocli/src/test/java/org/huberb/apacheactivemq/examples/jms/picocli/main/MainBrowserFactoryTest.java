...
import org.huberb.apacheactivemq.examples.jms.picocli.main.MainBrowserFactory;
 ...
 * @author berni3
 */
public class MainBrowserFactoryTest {

    public MainBrowserFactoryTest() {
    }

    MainBrowserFactory app;
    CommandLine cmd;
    StringWriter swOut;
    StringWriter swErr;
    ...
    public void testCommandLine_help(String helpOption) {
        ...
        assertTrue(swOutAsString.contains("Browse"), m);
