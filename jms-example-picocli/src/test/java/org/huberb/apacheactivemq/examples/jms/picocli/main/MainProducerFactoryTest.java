...
import org.huberb.apacheactivemq.examples.jms.picocli.main.MainProducerFactory;
 ...
 * @author berni3
 */
public class MainProducerFactoryTest {

    public MainProducerFactoryTest() {
    }

    MainProducerFactory app;
    CommandLine cmd;
    StringWriter swOut;
    StringWriter swErr;
