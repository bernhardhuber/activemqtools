 ...
 */
@MessageDriven(
        name = "TestTopicMessageListenerMessageDriven",
        activationConfig = {
            /*
            ...
            @ActivationConfigProperty(propertyName = "destination", propertyValue = "java:/jms/testTopic"),
            //@ActivationConfigProperty(propertyName = "destination", propertyValue = "testTopic"),
            // not supported @ActivationConfigProperty(propertyName = "destinationLookup", propertyValue = "java:/jms/testTopic"),
            // not supported @ActivationConfigProperty(propertyName = "connectionFactoryLookup", propertyValue = "java:/activemq/TestTopicMessageListenerConnectionFactory"),
            @ActivationConfigProperty(propertyName = "subscriptionDurability", propertyValue = "Durable"),
            @ActivationConfigProperty(propertyName = "subscriptionName", propertyValue = "subscriptionNameTestTopicMessageListener"),
            @ActivationConfigProperty(propertyName = "clientId", propertyValue = "clientIdTestTopicMessageListener"),
            @ActivationConfigProperty(propertyName = "maxSessions", propertyValue = "1"),})

public class TestTopicMessageListener implements MessageListener {

    private static final Logger logger = Logger.getLogger(TestTopicMessageListener.class.getName());
    ...
    public void onMessage(Message message) {
        ...
        JmsMessageStoreObserver.JmsMessageStoreEvent jmsMessageStoreEvent
                = new JmsMessageStoreObserver.JmsMessageStoreEvent(message, "categoryTestTopicMessageListener");
